        ...
        <div id="mynavbar" class="collapse navbar-collapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item ml-3" style="position:relative;">
                    <form action="{{route('productSubmitSearch')}}" class="form-inline" name="search-form"
                        ...
                        <div class="input-group">
                            <select id="nav-categories" name="category" class="custom-select input-group-prepend py-0">
                                ...
                                @foreach($fashions as $fashion)
                                    <option value="{{$fashion->fashion}}">{{$fashion->fashion}}</option>
                                @endforeach
                            </select>
                ...
                <li class="nav-item ml-4" style="font-size: 17px;">
                    <a href="{{route('admin_home_view')}}" class="nav-link"><span class="fas fa-fw fa-tachometer-alt"></span> &nbsp;DashBoard</a>
                </li>
        ...
        <div class="row">
            <div class="col-md-6">
                <ul id="main-menu" class="sm sm-mint" style="z-index: 3 !important;">
                    <li><a href="#" style="color: #c23616; padding-left: 0 !important;"><i class=" px-0 fas fa-align-left"></i>&nbsp;&nbsp;All
                            Categories</a>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled mt-2">
                    ...
                    <li><a href="#"><small>Return Policy</small></a></li>
            ...
            <div class="col-md-3 ">
                ...
                <ul class="list-unstyled mt-2">
                    ...
                    <li>
                        <a href="#"><span class="fab fa-instagram"></span>&nbsp;&nbsp;&nbsp;<small>Instagram</small></a>
                    </li>
                </ul>
            </div>
            <div class="col">
...
<script>
    ...
    // $('//#fashion-categories').on('mouseenter', 'li', function (event) {
    //     var fashion = $(this).children('a').text();
    //     var categories_container_id = $(this).children('ul').attr('id');
    //     var categories_container = $('#' + categories_container_id);
    ...
    //     $.ajax({
    //         dataType: 'json',
    //         url: "/filter/search-fashion-categories-list",
    //         method: "post",
    ...
    //                 categories_container.empty();
    //                 categories_container.append(response.result);
